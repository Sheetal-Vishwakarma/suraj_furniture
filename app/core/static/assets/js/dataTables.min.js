...
$(document).ready(function () {
    $('#result_list').DataTable({
        pageLength: 10, // Set number of records per page to 10
        columnDefs: [
            { orderable: true, targets: [2,3,4] }, // Enable sorting for these columns
    ...
    if (table) {
        ...
        var firstSpan = table.querySelector("span.dt-column-order");

        // If the <th> element exists, remove its parent <th>
        if (firstSpan) {
            firstSpan.remove();
            console.log('removed');
        }
...
// $(document).on('click','.djn-checkbox-select-all',function (e) {
//     alert('check alert working!');
// });
